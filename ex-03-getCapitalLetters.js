...
//input: string
//output: array of capital letters

var getCapitalLetters = function (stringInput){
  var arrCaps = [];
  for(var i = 0; i < stringInput.length; i ++){
      if(stringInput[i] === stringInput[i].toUpperCase() && stringInput[i] !== " "){
        arrCaps.push(stringInput[i]);
        // console.log(arrCaps);
      }
