...
//output:object with word frequency
...
var getWordCount = function(string){
  ...
  // wordArray[i] = wordArray[i].toLowerCase()
   var singleWord = wordArray[i].toLowerCase()
  //  console.log(singleWord)

   if( typeof frequencyObject[singleWord] === "undefined"){
     frequencyObject[singleWord] = 1;
   }
   else {
     frequencyObject[singleWord] = frequencyObject[singleWord] + 1;
   }
 }
